...
import transactionCard from "../../assets/transactionCard.png"
  ...
  return (
    <div className='flex'>
      ...
      <div className='hidden md:block w-[48vw] h-screen bg-violet-50 bg-auth-bg-img bg-cover bg-no-repeat bg-center overflow-hidden p-8 relative'>
        ...
        <img src={transactionCard} className='w-80 h-80 lg:w-[90%] absolute bottom-10 shadow-lg shadow-blue-400/15' />
      </div>
    </div>
  )
}
